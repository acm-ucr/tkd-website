...
const SparringGear = () => {
  return (
    <div className="relative w-fit justify-items-center font-bold text-white md:text-3xl lg:text-7xl">
      ...
      />
      <div className="absolute inset-0 flex flex-col items-center justify-center space-y-1 lg:space-y-12">
        <div className="mb-4 text-center text-xl max-md:text-3xl max-sm:mb-0 max-sm:text-lg md:text-3xl lg:text-5xl">
          Need Sparring Gear?
        </div>
        <div>
          <Button
