  ...
  return (
    <div className="w-screen">
      ...
      <div className="absolute right-[11%] top-[45%] h-[35%] w-[55%] bg-tkd-blue-200">
        <div className="absolute -top-[9%] right-[2.7%] h-[100%] w-[100%] border-4 border-white bg-transparent"></div>
        <p className="relative left-[13%] top-3 text-2xl font-semibold text-white">
          How often does your student organization meet?
        </p>
        <p className="relative left-[40%] top-3 text-2xl font-medium text-white">
          Twice a week.
        </p>
        <p className="relative left-1 top-10 text-2xl font-semibold text-white">
          What day and time does your student organization generally meet?
        </p>
        <p className="relative left-[16%] top-10 text-2xl font-medium text-white">
